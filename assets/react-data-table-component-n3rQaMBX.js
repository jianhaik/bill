...
`;function Dn({columns:e=[],conditionalRowStyles:t=[],defaultExpanded:o=!1,defaultExpanderDisabled:a=!1,dense:l=!1,expandableIcon:i,expandableRows:s=!1,expandableRowsComponent:g,expandableRowsComponentProps:b,expandableRowsHideExpander:C,expandOnRowClicked:u=!1,expandOnRowDoubleClicked:h=!1,highlightOnHover:j=!1,id:R,expandableInheritConditionalStyles:S,keyField:D,onRowClicked:w=k,onRowDoubleClicked:$=k,onRowMouseEnter:H=k,onRowMouseLeave:v=k,onRowExpandToggled:E=k,onSelectedRow:M=k,pointerOnHover:L=!1,row:x,rowCount:y,rowIndex:V,selectableRowDisabled:A=null,selectableRows:z=!1,selectableRowsComponent:U,selectableRowsComponentProps:O,selectableRowsHighlight:te=!1,selectableRowsSingle:ce=!1,selected:ne,striped:oe=!1,draggingColumnId:$e,onDragStart:Pe,onDragOver:ke,onDragEnd:De,onDragEnter:B,onDragLeave:he}){const[G,fe]=n.useState(o);n.useEffect(()=>{fe(o)},[o]);const Z=n.useCallback(()=>{fe(!G),E(!G,x)},[G,E,x]),He=L||s&&(u||h),Fe=n.useCallback(P=>{P.target.getAttribute("data-tag")===ze&&(w(x,P),!a&&s&&u&&Z())},[a,u,s,Z,w,x]),we=n.useCallback(P=>{P.target.getAttribute("data-tag")===ze&&($(x,P),!a&&s&&h&&Z())},[a,h,s,Z,$,x]),je=n.useCallback(P=>{H(x,P)},[H,x]),X=n.useCallback(P=>{v(x,P)},[v,x]),J=ie(x,D),{conditionalStyle:xe,classNames:Ce}=Ct(x,t,["rdt_TableRow"]),Ie=te&&ne,Te=S?xe:{},Me=oe&&V%2==0;return n.createElement(n.Fragment,null,n.createElement(kn,{id:`row-${R}`,role:"row",$striped:Me,$highlightOnHover:j,$pointerOnHover:!a&&He,$dense:l,onClick:Fe,onDoubleClick:we,onMouseEnter:je,onMouseLeave:X,className:Ce,$selected:Ie,$conditionalStyle:xe},z&&n.createElement(Cn,{name:`select-row-${J}`,keyField:D,row:x,rowCount:y,selected:ne,selectableRowsComponent:U,selectableRowsComponentProps:O,selectableRowDisabled:A,selectableRowsSingle:ce,onSelectedRow:M}),s&&!C&&n.createElement(Sn,{id:J,expandableIcon:i,expanded:G,row:x,onToggled:Z,disabled:a}),e.map(P=>P.omit?null:n.createElement(wn,{id:`cell-${P.id}-${J}`,key:`cell-${P.id}-${J}`,dataTag:P.ignoreRowClick||P.button?null:ze,column:P,row:x,rowIndex:V,isDragging:be($e,P.id),onDragStart:Pe,onDragOver:ke,onDragEnd:De,onDragEnter:B,onDragLeave:he}))),s&&G&&n.createElement(On,{key:`expander-${J}`,data:x,extendedRowStyle:Te,extendedClassNames:Ce,ExpanderComponent:g,expanderComponentProps:b}))}const Hn=p.span`
	padding: 2px;
	color: inherit;
	flex-grow: 0;
	flex-shrink: 0;
